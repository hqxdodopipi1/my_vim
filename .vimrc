...
autocmd BufNewFile *.h,*.hpp,*.cc,*.cpp,*.[ch],*.sh,*.rb,*.java,*.py exec ":call SetTitle()" 
""定义函数SetTitle，自动插入文件头 
func SetTitle() 
    if (expand("%:e") != 'sh' && expand("%:e") != 'py' && expand("%:e") != 'h' && expand("%:e") != 'hpp') 
        call setline(1, "/*************************************************************************") 
        call append(line("."), "	> File Name: ".expand("%")) 
	    call append(line(".") + 1, "	> Author: Morris") 
	    call append(line(".") + 2, "	> Mail: 100992036@qq.com") 
